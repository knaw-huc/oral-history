                ...
                <table id="resultTable">
                    <tr><th>Title</th><th>Status</th><th>Creator</th><th>Creation date</th><th><a href="{$home_path}index.php?page=new_rec&profile={$profile.profile_id}" id="addRec"><img src="{$home_path}img/add.ico" height="16px" width="16px"></a></th><th></th><th></th></th></tr>
                        ...
                        <tr class="{cycle values="odd,even"}">
                            ...
                            <td><a <a href="{$home_path}index.php?page=profile&id={$record.id}&action=delete_record" title="Delete" class="myBtn" id="myBtn{$record.id}" onclick="deleteRecord({$record.id}, {$profile.profile_id});"><img src="{$home_path}img/bin.png" height="16px" width="16px"></a></td>
                        </tr>
                    {/foreach}
                </table>
            </div>
