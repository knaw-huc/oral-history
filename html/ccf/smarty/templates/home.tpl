...
{*            <th></th>*}
        ...
        {foreach from=$profiles item=profile}
            <tr class="{cycle values="odd,even"}">
                ...
                <td><a href="{$home_path}index.php?page=profile&id={$profile.profile_id}&state=records"
                       title="View metadata records"><img src="{$home_path}img/more-items.png" height="16px"
                                                          width="16px"></a></td>
